...
HD_PWD='C:/Vivado/Parcial2_SD/Parcial2_SD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log space_invader_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source space_invader_top.tcl
