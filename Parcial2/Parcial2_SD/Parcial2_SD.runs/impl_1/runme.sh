...
HD_PWD='C:/Vivado/Parcial2_SD/Parcial2_SD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log space_invader_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source space_invader_top.tcl -notrace
