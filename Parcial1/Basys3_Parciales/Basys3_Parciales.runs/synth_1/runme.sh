...
HD_PWD='C:/Vivado/Basys3_Parciales/Basys3_Parciales.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FSM_Complete.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FSM_Complete.tcl
