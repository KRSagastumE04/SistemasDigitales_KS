...
HD_PWD='C:/Vivado/Basys3_Parciales/Basys3_Parciales.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FSM_Complete.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FSM_Complete.tcl -notrace
