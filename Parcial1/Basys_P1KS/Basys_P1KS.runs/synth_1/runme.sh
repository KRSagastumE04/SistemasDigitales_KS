...
HD_PWD='C:/Vivado/Basys_P1KS/Basys_P1KS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_alarm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_alarm.tcl
