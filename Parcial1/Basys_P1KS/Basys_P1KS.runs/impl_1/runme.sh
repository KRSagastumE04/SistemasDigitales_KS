...
HD_PWD='C:/Vivado/Basys_P1KS/Basys_P1KS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_alarm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_alarm.tcl -notrace
